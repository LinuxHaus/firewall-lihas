...
DEBIAN_DEPENDS=iptables,libdbd-sqlite3-perl,libdbi-perl,liblog-dispatch-perl,liblog-log4perl-perl,libxml-application-config-perl,libxml-xpath-perl,perl (>= 5.12)
...
debian-upload:
	curl -u `cat $(HOME)/.debianrepositoryauth` -v $(UPLOADURL) -F B1="Datei hochladen" -F uploaded_file=@../$(APPNAME)_$(VERSION)_$(ARCH).deb -F dists="bullseye,bookworm,trixie,forky"
